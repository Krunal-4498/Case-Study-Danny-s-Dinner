...
## Code
To create database and insert values into it and for detail solution codes refer [Case Study #1 - Danny's Diner.sql](https://github.com/Krunal-4498/Case-Study-Danny-s-Dinner__using_MySQL/tree/main)
```sql
